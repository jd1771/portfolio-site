export const projectData = [
  {
    id: 1,
    title: "ReelMarks",
    description: "An API built with Express.js that generates timestamps for YouTube videos, optimized with Redis caching for fast response times and containerized using Docker.",
    githubUrl: "https://github.com/jd1771/ReelMarks",
  },
  {
    id: 2,
